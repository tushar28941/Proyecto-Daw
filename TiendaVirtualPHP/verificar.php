    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                <div class="card-body">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="checkout.php">Iniciar sesion</a></li>
                        <li class="breadcrumb-item"><a href="direccion.php">Datos de envío</a></li>
                        <li class="breadcrumb-item"><a href="pago.php">Forma de pago</a></li>
                        <li class="breadcrumb-item active">Revisar</li>
                    </ol>
                    <h2>Verifique los datos</h2>
                    <p>Método de pago: <?php print $pago; ?></p>
                    <p>Nombre: <?php print $_SESSION["usuario"]["nombre"]." ".$_SESSION["usuario"]["apellido1"]." ".$_SESSION["usuario"]["apellido2"]; ?></p>
                    <p>Dirección: <?php print $_SESSION["usuario"]["direccion"].", ".$_SESSION["usuario"]["localidad"].", ".$_SESSION["usuario"]["ciudad"]; ?></p>
                    <p>Código postal: <?php print $_SESSION["usuario"]["codpos"]; ?></p>
                    <br><br>
                    <?php desplegar($carrito, 1, $conn); ?>
                </div>
            </div>
            <div class="col-sm-2 sidenav">
