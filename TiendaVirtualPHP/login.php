                ...
                <?php endif; ?>
                    ...
                    <form method="POST" action="login.php" class="text-left">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" value="<?php print $email; ?>" class="form-control" placeholder="Escribe el email">
                        </div>
                        <div class="form-group">
                            <label for="email">Contraseña:</label>
                            <input type="password" name="clave" id="clave" value="<?php print $clave; ?>" class="form-control" placeholder="Escribe la contraseña">
                        </div>
                        <div class="checkbox">
                            <label for="checkbox"><input type="checkbox" name="recordarme" id="recordarme">Recordarme</label>
                        </div>
